...
<p class="breadcrumb" style="margin-bottom: 0"><a href="../index.php">UMBC at The Universities at Shady Grove</a> / Faculty Resources</p>
</div>
...
<div id="sub_content">
  ...
  <p>&nbsp;</p>
  <p style="margin-bottom: 0;"><a href="http://www.umbc.edu/fdc/" target="_new">UMBC Faculty Development Center</a></p>
  <p style="margin-top: 0;"><a href="http://www.umbc.edu/provost/Faculty_Handbook/contents.pdf" target="_new">UMBC Faculty  Handbook</a></p>
<p style="margin-bottom: 0;">&nbsp;</p>
<p style="margin-top: 0; margin-bottom: 0;"><strong>Handouts and &quot;Cheat Sheets&quot;:</strong></p>
<ul style="margin-top: 0;">
    <ul>
      <li><a href="http://www.umbc.edu/fdc/teaching_learning.php" target="_new">Teaching  and Learning Topics</a></li>
      <li><a href="http://www.cmu.edu/teaching/solveproblem/index.html" target="_new">Solving a  Teaching Problem</a></li>
      <li><a href="http://www.umbc.edu/shadygrove/documents/TheSyllabusasaTEachingTool2013.docx" target="_new">The  Syllabus as a Teaching Tool</a></li>
      <li><a href="http://www.umbc.edu/shadygrove/documents/TeachingEffectivelyandEfficientlylogo.doc" target="_new">Teaching  Effectively and Efficiently</a></li>
      <li><a href="http://www.umbc.edu/shadygrove/documents/PromotingStudentsAbilitytoRetainInformationandApplyIt.docx" target="_new">Promoting  Students' Ability to Retain Information and Apply it in New Situation</a></li>
      </ul>
    <p><strong>Top Teaching Books: </strong></p>
    <ul style="margin-bottom: 0;">
      ...
      <li>Walvoord, B.  E., &amp; Anderson, V. J. (2010). <strong>Effective grading: A tool for  learning and assessment in college </strong>(Second edition). San Francisco:  Jossey-Bass.</li></ul></ul>
  <p style="margin-bottom: 0;"><strong>Recorded Development Sessions</strong>:</p>
<ul style="margin-top: 0;">
    <ul style="margin-bottom: 0">
      <li><a href="http://www.youtube.com/watch?v=AIxPjRv0S0I" target="_new">iPads in  the Classroom</a></li>
      <li><a href="http://www.youtube.com/watch?v=4ZuKNRiANOg" target="_new">Viewing  Class and Grade Rosters</a></li>
    </ul>
  </ul>
  <p><a href="http://www.shadygrove.umd.edu/faculty/faculty-resources" target="_parent"><strong>USG Faculty  Resources</strong></a></p>
  <ul>
    <li><a href="http://www.shadygrove.umd.edu/library/services/streaming-video" target="_new">Films on  Demand</a></li>
    <li><a href="http://www.umbc.edu/shadygrove/documents/FOD-IntegrationTips-EmebeddingandTitleorSegmentURLS.pdf" target="_new">Integration</a></li>
    <li><a href="http://www.umbc.edu/shadygrove/documents/FOD-UMBCwalkthrough.docx" target="_new">Features</a></li>
  </ul>
  <p style="margin-bottom: 0;"><a href="http://www.umbc.edu/provost/Faculty_Handbook/contents.pdf" target="_new"></a> <br>
  <br>
 </p>
</div>
