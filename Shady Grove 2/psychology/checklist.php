...
<head>
    <meta charset="UTF-8" />
    <title>Admitted Student Checklist | Psychology | UMBC at Shady Grove</title>
...
<div id="container">
        ...
        <div class="window_overlay">
          <p style="font-family: Palatino Linotype, Book Antiqua, Palatino, serif;font-size:2.9em;color:#fff;position:relative;margin-top:1px;padding-left:10px">Psychology</p></div>
...
<p class="breadcrumb" style="margin-bottom: 0"><a href="../index.php">UMBC at The Universities at Shady Grove</a> / Undergraduate / Psychology / Admitted Student Checklist</p><div id="leftnav">
