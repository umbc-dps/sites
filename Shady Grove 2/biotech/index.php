...
<!DOCTYPE html>
  ...
  <title>Biotechnology | UMBC at Shady Grove</title>
  ...
  <!-- Open Graph data -->
  <meta property="og:title" content="Biotechnology | UMBC at Shady Grove" />
  ...
  <body>
    ...
    <div class="eleven columns">
      <div class="cbp-fwslider" id="cbp-fwslider">
        <ul>
        <li>
        <a href="http://www.umbc.edu/biotech" target="_blank"><img alt="img03" src="images/4.jpg"></a>
  
  <div class="carousel-caption-right wordwrap">
  <h3>Not Currently Accepting Applications</h3>
    <small>Currently, we are not accepting applications for the Shady Grove location. Learn more about the main campus program in Baltimore.</small>
  
  <p><a class="web-seemore" href="http://www.umbc.edu/biotech" target="_blank">Learn More</a></p></div>
  
  <p id="captionthree"><a href="http://www.umbc.edu/biotech">Not Currently Accepting Applications</a></p>
  </li>
  ...
  <small>Join us for a webinar as Dr. Stephen Miller, Program Director of UMBC Biotechnology Graduate Programs, discusses the key elements of landing one a Biotechnology jobs. </small>
  ...
  <p id="captionthree"><a href="http://gradschool.umbc.edu/admissions/apply" target="_blank">Apply for Spring 2016</a></p>
  ...
  <!-- END HIDE SLIDES -->
      ...
      <p>The Master’s in Professional Studies in Biotechnology prepares recent college gradudates and science professionals to fill management, product development, and leadership roles in biotechnology-related companies or agencies. &nbsp;</p>
      <p>
      ...
      <p>Global challenges in human health, food security, sustainable industrial production and environmental protection continues to fuel the biosciences industry, creating new opportunities within
      the four primary sub sectors:</p>
  
  
      <ul>
        <li>Agricultural feedstock and chemicals</li>
  
  
        <li>Drugs and pharmaceuticals</li>
  
  
        <li>Medical devices and equipment and research</li>
  
  
        <li>Testing and medical laboratories</li>
      </ul>
...
<!-- END Content -->
    ...
    <footer class="clearfix" id="site-footer">
      <div class="full-width column add-bottom">
        <h3>Biotechnology Job Outlook</h3>
  
  
        <p>Over the past decade the industry has added nearly 111,000 new, high-paying jobs or 7.4 percent to its employment base, <a href=
        "https://www.bio.org/articles/battellebio-state-bioscience-jobs-investments-and-innovation-2014" target="_blank">according to the latest Battelle/BIO report</a>.<br>
        <br>
        Economic output of the bioscience industry has expanded significantly with 17 percent
        growth for the biosciences since 2007, nearly twice the national private sector nominal output growth.</p>
      </div>
      <br clear="all">
