...
<html lang="en"><head>
<meta charset="UTF-8" />
<title>Advising Guides | Student Resources | UMBC at Shady Grove</title>
...
<p class="breadcrumb" style="margin-bottom: 0"><a href="../index.php">UMBC at The Universities at Shady Grove</a> / Advising Guides</p>
</div>
...
<div id="sub_content">
  ...
  <p style="margin-bottom: 0;"><strong>Undergraduate&nbsp;Programs:</strong></p>
  <ul style="margin-top: 0;">
    <li><a href="documents/201415GenReqsWkshtHIST.pdf" target="_blank">History</a></li>
    <li><a href="MC_Checklist_POLI.pdf" target="_new">Political Science</a></li>
    <li><a href="documents/AdvisingWorksheet_7.22.2015.pdf" target="_blank">Psychology</a></li>
    <li><a href="documents/AdvisingchecklistSOWK_7.22.2015.docx" target="_blank">Social Work</a></li>
    </ul>
  <p style="margin-bottom: 0;"><strong>Graduate Programs:</strong></p>
  <ul style="margin-top: 0;">
    <li><a href="documents/BTEC-PlanningForm.pdf" target="_blank">Biotechnology</a></li>
    <li><a href="documents/Cyber-PlanningForm.pdf" target="_blank">Cybersecurity</a></li>
    <li><a href="documents/GIS-PlanningForm.pdf" target="_blank">Geographic Information Systems</a></li>
    <li><a href="documents/IO-Planning-Form.pdf" target="_blank">Industrial Organizational Psycholog</a>y</li>
  </ul>
