...
<body id="home" onLoad="MM_preloadImages('images/apply_over.png','images/visit_over.png','images/info_over.png')">
...
<h2><a href="http://www.shadygrove.umd.edu/" target="_blank">UMBC at Shady Grove</a></h2>
...
<div class="mainbox" id="featured"> <img src="images/UMBC_ShadyGrove_UndergradPrograms.jpg" class="main" border="0">
<h3>UMBC-Shady Grove Undergraduate Programs</h3>
	<div class="boxleft">          
      <h6>UMBC  at The Universities at Shady Grove offers undergraduate programs in History,  Political Science, Psychology and Social Work. 
        
        Apply by Dec. 15 for Spring 2014.
        
      </h6>
    </div><!-- end boxleft nested div -->

	<div class="boxright">
		<div class="button">Attend an Info Session </div>
  	</div><!-- end boxright nested div -->
        
<div class="boxfull"></div>
<!-- LEAVE LINK <a href="http://www.umbc.edu/shadygrove" id="slick-show6" class="plus"></a>-->
</div>

        <div id="slickbox6" class="toggle3 left2 boxtext">
        <img src="images/UMBC_Cybersecurity_ShadyGrove.jpg">
        <h2>Biotechnology and Cybersecurity</h2>
        <h6>With a focus on management, these programs prepare students in the technology-centric Rockville area for leadership roles in two of the region’s fastest growing industries.</h6>
        
        <a href="#" id="slick-hide6" class="minus"></a>
...
<div class="formbox"><a href="info/apply.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APPLY','','images/apply_over.png',1)"><img id="APPLY" src="images/apply.png" alt="APPLY"></a><a href="info/visit.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('VISIT','','images/visit_over.png',1)"><img id="VISIT" src="images/visit.png" alt="VISIT"></a><a href="info/contact.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('INFO','','images/info_over.png',1)"><img id="INFO" src="images/info.png" alt="REQUEST INFO"></a> </div>
...
<!-- LEAVE LINK<a href="#" id="slick-show3" class="plus"></a> BELOW ALONE -->
        ...
        <div id="slickbox3" class="toggle left2 boxtext">
          ...
          <p><h6>From our convenient Rockville location, to our accommodating evening class schedule, Professional Master’s and Graduate Certificate programs are designed with working professionals in mind.</h6></p>
...
<!-- LEAVE LINK <a href="#" id="slick-show4" class="plus"></a> BELOW ALONE -->
                ...
                <!-- ESL Rollover Box Content Below -->
                <div id="slickbox4" class="toggle left3 boxtext">
                <h2>Faculty </h2>
                <p><h6>Content to come</h6></p>
                ...
                <!-- LEAVE LINK BELOW ALONE -->
                <a href="#" id="slick-hide4" class="minus"></a>
                </div>



<!-- Prof Training Original Box Content Below -->
...
<p><a href="documents/Winter2014_TextbookListing.pdf">Textbooks</a></p>
<p><a href="http://registrar.umbc.edu/academic-calendar/">Academic Calendar</a></p>
<p><a href="shared/financing.php">Financing Your Education</a></p>
<p><a href="http://www.shadygrove.umd.edu/library">Library</a></p>
<p><a href="https://secure.vzorientation.com/umbc/">Undergraduate Orientation</a></p>
<p><a href="shared/meetthestaff.php">Meet the Staff</a></p>
...
<!-- LEAVE LINK <a href="#" id="slick-show5" class="plus"></a>BELOW ALONE -->
        ...
        <div id="slickbox5" class="toggle right boxtext">
                <h2>TBD </h2>

                <p>TBD</p>
                
                <!-- LEAVE LINK BELOW ALONE -->
          <a href="#" id="slick-hide5" class="minus"></a>
        </div>
...
<img src="images/UMBC_Shady_Grove_logo.png" width="210" border="0">
</div>

<div class="table" style="float:left;">
<table width="460" border="0" cellspacing="3" cellpadding="3"><h4>Upcoming Events</h4>
  <tr>
    <td><a href="#">I/O Psychology Info Session</a><br>
    1/23 - 6:00 p.m.

 </td>
    <td><p><a href="#">Undergraduate Info Session</a></p>
      <p>11/22 - 12: 30 p.m. </p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><p><a href="#">Undergraduate Info Session</a></p>
      <p>12/6 - 12: 30 p.m. </p></td>
  </tr>
  <tr>
    <td></td>
    <td><p><em>All upcoming info session dates. </em></p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<a href="https://www.facebook.com/UMBCatShadyGrove?ref=hl" target="_blank"><img src="images/fb.png" class="btn" alt="facebook" style="margin-left:5px;"></a>
...
<div class="footercontent">
  <p>&copy; 2013 UMBC at The Universities at Shady Grove  •  9636 Gudelsky Drive, Rockville, MD 20850  •  301-738-6081  •  E-mail: shadygrove@umbc.edu</a><br>
<p><a href="http://www.umbc.edu/ola/nondiscrimination.html" target="_blank">UMBC is an Equal Opportunity and Affirmative Action Institution</a></p>
</div>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-1756263-16']);
