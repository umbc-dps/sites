...
<title>Master's of Professional Studies | Biotechnology at UMBC</title>
...
<!-- Open Graph data -->
<meta property="og:title" content="Master's of Professional Studies | Biotechnology at UMBC" />
...
<!-- START Content --> 
 ...
 <h3>Master's of Professional Studies: Biotechnology</h3>
 ...
 <ul>
   ...
   <h5>Biotech Core: 6 courses [18 credits]</h5>
   <ul>
   ...
   <h5>Bioprocessing Track [12 credits]</h5>
   <ul>
     <li>BTEC 653: <a href="courses.php#653">Principals of Upstream Processing</a> [3]</li>
     <li>BTEC 658: <a href="">Principals of Downstream Bioprocessing</a> [3] </li>
     <li>BTEC 659: <a href="">Fundamentals of Bioprocess Development</a> [3] </li>
     <li>BTEC/ ENCH 664: <a href="courses.php#664">Quality Control and Quality Assurance for Biotechnology Products</a> [3]</li>
   </ul>
