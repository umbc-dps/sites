...
http://umbc.edu/biotech";

// Send E-Mail and Direct Browser to Confirmation Page
mail($SendTo, $SubjectLine, $MsgBody2, "From: Nancy Clements <nancyc@umbc.edu>");
