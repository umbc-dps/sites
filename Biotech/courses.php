...
<title>Course Descriptions | Biotechnology at UMBC</title>
...
<!-- Open Graph data -->
<meta property="og:title" content="Course Descriptions | Biotechnology at UMBC" />
<meta property="og:type" content="article" />
<meta property="og:url" content="http://www.umbc.edu/biotech/courses" />
...
<div class="accordionheader">
  <h4><a href="#652" id="652"></a>BTEC 652: Molecular Biotechnology [3]<i class="fa fa-angle-down"></i></h4>
          ...
          <div class="accordionbody">
            <p>A lecture, discussion and project-based course that focuses on the molecular and genetic tools used to analyze and modify genetic material and used to modify organisms to produce desired small molecules and proteins.  Topics will include the properties and uses of biotechnology-useful enzymes, sequencing techniques, PCR, cloning vectors and hosts, DNA and protein microarrays, directed mutagenesis, and the manipulation of  expression (and its levels) of particular gene products.  The experimental and model systems that will be studied include bacteria, yeast, plant, and higher mammals. Extensive use of the Internet&rsquo;s resources and on-line journals will be also expected. <strong>Prerequisite:</strong> BTEC 651 or permission of instructor
              </p>
              <br>
</p>
   </div>
...
<div class="accordionheader">
  ...
  <h4><a href="#657" id="657"></a>BTEC 657: Biochemical Engineering [3]</h4>
      ...
      <div class="accordionheader">
  <h4><a href="#658" id="658"></a>BTEC 658: Principals of Downstream Processing [3]</h4>
          </div>
      ...
      <div class="accordionheader">
  <h4><a href="#659" id="659"></a>BTEC 659: Fundamentals of Bioprocess Development [3]</h4>
          </div>
...
<div class="accordionheader">
  <h4><a href="#665" id="665"></a>BTEC 665: Management, Leadership and Communication [3]<i class="fa fa-angle-down"></i></h4>
          </div>
