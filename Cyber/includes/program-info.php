<table id="forminfo">
  ...
  <tr>
    <td>bio</td>
    <td>Nancy  Clements, Academic Program Specialist</td>
    <td>nancyc@umbc.edu</td>
    <td>scrosby@umbc.edu</td>
    <td>https://youtu.be/ZMQH20Gj9ZU</td>
    <td>UMBC&rsquo;s  Biotechnology program represents a new kind of degree designed to prepare  science professionals to fill management and leadership roles in  biotechnology-related companies or agencies. This unique degree provides  advanced instruction in the life sciences, along with coursework in regulatory  affairs, leadership, management, and financial management in a life  science-oriented business.</td>
  </tr>
  <tr>
    <td>bio-sg</td>
    <td>Rickeysha  Jones, Program Coordinator </td>
    <td>jcjones@umbc.edu</td>
    <td>scrosby@umbc.edu, awaters@umbc.edu,</td>
    <td>https://youtu.be/ZMQH20Gj9ZU </td>
    <td>UMBC&rsquo;s  Biotechnology program represents a new kind of degree designed to prepare  science professionals to fill management and leadership roles in  biotechnology-related companies or agencies. This unique degree provides  advanced instruction in the life sciences, along with coursework in regulatory  affairs, leadership, management, and financial management in a life  science-oriented business.</td>
  </tr>
    <td>cyber</td>
    <td>Lisa Gambino, Assistant Director</td>
    <td>gambino@umbc.edu</td>
    <td>scrosby@umbc.edu</td>
    <td>https://youtu.be/ecx3c_h-IgU</td>
    <td>UMBC’s Cybersecurity program reflects the interdisciplinary nature of the modern cybersecurity environment offering students the necessary educational experience required for successful and effective cybersecurity practice in today’s workforce. Since our program blends both the technical and non-technical aspects of cybersecurity, our graduates share a common understanding of the operational cybersecurity environment and also have the opportunity to expand their knowledge on specific cybersecurity interests.</td>
  </tr>
    <tr>
    <td>cyber-sg</td>
    <td>Rickeysha  Jones, Program Coordinator</td>
    ...
    <td>gambino@umbc.edu</td>
    <td>scrosby@umbc.edu</td>
    <td>https://youtu.be/Iya3IKmLKio</td>
  ...
  <tr>
    ...
    <td>scrosby@umbc.edu</td>
    <td>https://youtu.be/odguhEY9UDU</td>
   ...
   <tr>
    ...
    <tr>      <td>io</td>
      ...
      <td>The  Master of Professional Studies: Industrial/Organizational Psychology Program is  designed to provide advanced education to early/mid-career professionals in the  areas of human capital functions, personnel selection, and training and  organizational management.</td>
        ...
        <tr>
      <td>isd</td>
      <td>Renee  Eisenhuth, Graduate Program Coordinator</td>
      <td>reisen@umbc.edu</td>
      <td></td>
      <td></td>
      <td>UMBC  The Instructional Systems Development (ISD)-Training Systems program is UMBC&rsquo;s  most established graduate program that has been educating professionals in the  field of training and development for over 40 years.</td>
    </tr>
        <tr>
      <td></td>
      <td>John  Nelson, TESOL Program Co-Director</td>
      <td>jnelson@umbc.edu</td>
      <td></td>
      <td></td>
