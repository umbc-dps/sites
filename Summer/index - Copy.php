...
<!-- Slide Two -->
<li id="slide2">
	<a href="http://gritgoing.umbc.edu/featured-course-animal-behavior/">
    	<img src="images/featured/biol480.jpg" alt="Featured Course: Animal Behavior" target="_blank">
	</a>
	<div class="carousel-caption wordwrap">
		<h3>Featured Course: Animal Behavior <br>(BIOL 480)</h3>
		<small>Learn about the themes and questions important to understanding animal behavior in this writing intensive course.</small>
