  ...
  <!--
        ...
        -->
        <li><a href="coursesprerequisites">Courses with Prerequisites</a></li>
        <li><a href="gep">General Education Program (GEP) Courses</a></li>
    ...
    <li><a href="#">Register/Apply</a>
      <ul class="sub-menu">
        <li><a href="registrationtips">Registration Tips</a></li>
        <li><a href="scheduleadjustment">Schedule Adjustment</a></li>
        <li><a href="https://highpoint-prd.ps.umbc.edu/app/dashboard" target="_blank">Register Through myUMBC</a></li>
        <li><a href="visitingstudents">Apply (Visiting Students)</a> </li>
      </ul>
    </li>
    <li><a href="importantdates">Dates/Deadlines</a> 
      <ul>
        <li><a href="importantdates">Academic Deadlines</a></li>
        <li><a href="financialdates">Financial Deadlines</a></li>
      </ul>
    </li>
    <li><a href="tuition">Tuition &amp; Fees</a>
      <ul class="sub-menu">
        <li><a href="tuition">Tuition</a></li>
        <li><a href="billing">Paying Your Bill</a></li>
        <li><a href="financialaid">Financial Aid</a></li>
        <li><a href="scholarships">Scholarships</a></li>
      </ul>
    </li>
        <li><a href="services">Student Services</a>       
          <ul class="sub-menu">
