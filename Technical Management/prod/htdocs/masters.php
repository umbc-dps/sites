...
<html lang="en">
  <head>
<title>Master's Admissions | Technical Management at UMBC</title>
...
<!-- START Content --> 
 <h3>Admissions: Domestic Student</h3>
...
<p>The application deadline for Fall 2017 is <strong>August 1</strong><br>
 ...
 <p>A bachelor’s degree in a science, technology, engineering, mathematics related field.</p>
 ...
 <ul>
   ...
   <li>Applicants should have at least two years experience in a technical field</li>                                                          
 ...
 <ul>
   <li style="list-style-type:decimal"><a href="http://gradschool.umbc.edu/admissions/apply" target="_new">Apply online</a>
     <ul>
       <li>Select proposed program Technical Management  &gt;&gt; Technical Management (PRST MPS)</li>
 ...
 <ul>
   ...
   <li>Resume (When applying online, upload your resume to the graduate school application.)</li>
...
UMBC Graduate School, MPS: Technical Management <br>
   1000 Hilltop Circle<br>
   Baltimore, MD 21250</p>
 <p>If you require further assistance, please contact <a href="mailto:kedmonds@umbc.edu">Kim Edmonds</a> or call 410-455-3445. </p>
