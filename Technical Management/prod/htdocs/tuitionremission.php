...
<!-- END Page Header --><div class="eleven columns">
      ...
      <h3>Tuition Remission</h3>


      <p>As an employer, tuition remission is an employee benefit that is highly sought by top talent. Our Technical Management Masters Degree will provide employees with skills, insights & tools directly applicable to their job from day one. </p>

	<p><a href="contact">Contact us</a> to discuss the tuition remission policy can look like. We work to ensure HR departments receive the documentation needed to pay for courses or reimbursement. </p>


<h4>Tuition Remission Resources</h4>
<ul>
<li><a href="costs">Tuition & Fees Cost</a></li>
</ul>
 <br>
 <br>
