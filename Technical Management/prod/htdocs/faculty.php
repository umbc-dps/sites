...
<title>Faculty | Technical Management at UMBC</title>
...
<meta property="og:description" content="This Master's program provides practicing engineers with technical expertise in technical management." />
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1" href="#viewport">
...
<div class="accordionbody">
  <p><img src="images/faculty/umbc-faculty-Toby-Gouker.gif" alt="Toby Gouker" align="left"/>
  
  B.S., Chemical Engineering, Worcester Polytechnic Institute<br>
...
<div class="accordionheader">
  <h4><a id="gantzer" href="#gantzer"></a>Don Gantzer | Adjunct Instructor<i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">
 ...
 <a href="#jones" id="jones"></a>Michelle Jones | Adjunct Instructor <i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">
  <h4> <a href="#kirkwood" id="kirkwood"></a>Keith R. Kirkwood | Adjunct Instructor <i class="fa fa-angle-down"></i></h4>
</div>
...
<p>Dr. Thomas G. Moore is the Graduate Program Director for the Systems Engineering and Engineering Management programs at UMBC. Dr. Moore has worked over 25 years in industry designing, developing, and testing products. His most recent position was the Director of Systems Engineering and Logistics for Northrop Grumman Electronic Systems. While at Electronic Systems, Dr. Moore held a variety of positions ranging from technical strategy development to business-area director, responsible for capturing and executing technology development programs.</p>
...
<div class="accordionheader">
  <h4>
<a href="#negahban" id="negahban"></a>Sam Negahban Ph.D. | Adjunct Instructor <i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">
  <h4> <a href="#oliver" id="oliver"></a>Michael Oliver, J.D. | Adjunct Instructor<i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">
  <h4> <a href="#powell" id="powell"></a>Jonathan Powell | Adjunct Instructor<i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">  
<h4> <a href="#ray" id="ray"></a>Jeff Ray, D.Mgt. | Adjunct Instructor<i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">  
<h4> <a href="#stout" id="stout"></a>Lawrence Stout, Ph.D. | Adjunct Instructor<i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">  
<h4> <a href="#swassing" id="swassing"></a>Charles R. Swassing, II | Adjunct Instructor<i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">  
<h4> <a href="#wilson" id="wilson"></a>Richard Wilson | Adjunct Instructor<i class="fa fa-angle-down"></i></h4>
</div>
...
<div class="accordionheader">
  <h4>
<a href="#ziegler" id="ziegler"></a>James Ziegler | Adjunct Instructor<i class="fa fa-angle-down"></i></h4>
</div>
