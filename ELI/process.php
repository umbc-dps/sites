...
// START BUILDING HTML TABLE FOR EMAIL TO STAFF
			...
			$theTable .= "<tr><th " .'align="left"'. ">Name: </th><td>$firstname $middlename $lastname</td></tr>";
			...
			$theTable .= "<tr style=" . '"background:#f5f5f5;"' . "><th " .'align="left"'. ">Address: </th><td>$address, $apt, $city, $state, $country, $zip</td></tr>";
			$theTable .= "<tr><th " .'align="left"'. ">Phone: </th><td>$phone</td></tr>";
