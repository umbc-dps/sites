...
<p style="text-align:center; margin-top:-15px"><strong>UMBC Cybersecurity Virtual Info Session</strong><br />
    ...
    <aside class="five columns add-bottom" id="two">
      ...
      <p style="text-align:center">For spring consideration, apply by: <br />
        January 10, 2016
...
<input name="program" type="hidden" value="Cybersecurity Request Information Form">
