...
<title>Faculty | Cybersecurity | UMBC at Shady Grove</title>
...
<!-- Open Graph data -->
<meta property="og:title" content="Faculty | Cybersecurity | UMBC at Shady Grove" />
<meta property="og:type" content="article" />
<meta property="og:url" content="http://www.umbc.edu/shadygrove/cyber/faculty" />
...
<!-- START Content --> 
<h3>Faculty</h3>
<div class="accordionheader" style="background-color:#E0C586; font-weight:bold">
  <h4>Faculty</h4>
</div>
<div></div>
...
<div class="accordionheader">
  <h4>Mike Stone | Adjunct Instructor <i class="fa fa-angle-down"></i></h4>
</div>

<div class="accordionbody">
   <p><img align="left" src="images/faculty/umbc-faculty-Mike-Stone.jpg">Mike Stone is a senior security analyst at the National Cybersecurity Center of Excellence (NCCoE) at the National Institute of Standards and Technology. The NCCoE collaborates with members of industry, government and academia to build open, standards-based, modular and practical example reference designs that address cybersecurity challenges in key economic sectors. The center benefits from formal partnerships with market leaders including several Fortune 50 companies.</p>
...
<div class="accordionbody">
  <p><img align="left" src="images/faculty/umbc-faculty-Don-Tobin.jpg">Don Tobin is a Senior Security Engineer at the National Cybersecurity Center of Excellence (NCCoE) at the National Institute of Standards and Technology.  Don&rsquo;s primary roles are to work with private industry in the transportation sector to identify their major cybersecurity challenges, and work with NCCoE partners to formulate solutions to those challenges.</p>
  <p>He previously led the NOAA Security Operations Center (SOC) to a 24/7 operations work center in support of NOAA&rsquo;s Cyber Security Center.  He was also a professor at Fairmont State University for 10 years where he created a computer security undergraduate major and developed coursework for 9 upper-level courses.  He is also a retired USAF officer.  Don holds bachelor&rsquo;s degree in mathematics from the University of Texas at Arlington and a master&rsquo;s degrees in computer science from Boston University, and has published several papers in the information security and intrusion detection areas.
  </p>
</div>


<div class="accordionheader" style="background-color:#E0C586; font-weight:bold">
  <h4>Engineering Management Faculty</h4>
</div>
<div></div>

<div class="accordionheader">
  <h4>Jonathan Powell, MBA | Adjunct Instructor <i class="fa fa-angle-down"></i></h4>
</div>
