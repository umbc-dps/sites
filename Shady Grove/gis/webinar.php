...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en_US"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="https://attendee.gotowebinar.com/styles/main.css?Apr 29, 2015 12:26:51 PM">
        ...
        <!--[if IE 7]><link type="text/css" rel="stylesheet" href='/styles/g2wattendee-ie7.css'><![endif]-->
                                    ...
                                    <link rel="stylesheet" href="https://attendee.gotowebinar.com/styles/registration.css?$Apr 29, 2015 12:26:51 PM">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                                                                <input type="hidden" id="training-key" value="4998472583927650049" />
...
<div class="branding-image">
    <img src="http://images.gotowebinar.com/4554f5433fce940648dfe64c8121c1dd" alt="UMBC Geographic Information Systems Virtual Information Session" class="img-responsive">
</div>
<h1>UMBC Geographic Information Systems Virtual Information Session</h1>
</div>
...
<form id="registrationForm" action="https://attendee.gotowebinar.com/registration.tmpl" method="POST" role="form">
    <div class="trainingTimesBox clearfix">
                ...
                <ol id="training-times" class="trainingTimes">
	    		    	        	        	                                                            	        <li class="next">Tue, Jun 16, 2015 6:00 PM - 7:00 PM EDT</li>
	     </ol>
            </div>
            <div class="row col-md-12">
...
<div class="description trainingDescription" >
            <div class="clearfix">
                <span>Where can a Master's of Professional Studies Degree or Graduate Certificate in Geographic Information Systems take you?
<br>
<br>Join us for the session to learn about the UMBC's Geographic Information Systems programs at UMBC's Main Campus and UMBC-Shady Grove in Rockville, MD. The session will provide an overview of our innovative curriculum, practice-oriented instruction and flexible class schedules, which are designed for working professionals. 
<br>
<br>Learn about admissions, curriculum, class format and the cybersecurity career outlook.</span>
        </div>
</div>
<hr>
    <script>
...
<div class="row">
                <input type="hidden" id="webinar" name="webinar" value="4998472583927650049" > 		
...
<div id="customQuestions" class="row">
		                ...
		                <input type="hidden" name="customRegistrationSubmission.answers&#91;0&#93;.questionKey" value="16402930">
        			<div class="form-group  col-sm-12">
            	    <label id="customRegistrationSubmission.answers_0.selectedOptionsLabel" class="control-label "     >How did you learn about this information session?</label>
    ...
    >
			...
			Choose One...		</option>
                    ...
                    <option value="16402931" >
            Email
        </option>
                    <option value="16402932" >
            Facebook
        </option>
                    <option value="16402933" >
            Radio/Internet Radio
        </option>
                    <option value="16402934" >
            LinkedIn
        </option>
                    <option value="16402935" >
            Other
        </option>
    	</select>
    </div>
		                ...
		                <input type="hidden" name="customRegistrationSubmission.answers&#91;1&#93;.questionKey" value="16402956">
                                           <div class="form-group  col-sm-12">
...
<script src="https://attendee.gotowebinar.com/scripts/app.js?Apr 29, 2015 12:26:52 PM"></script>
<script src="https://attendee.gotowebinar.com/scripts/page/registration.js?Apr 29, 2015 12:26:52 PM"></script>



<script src="https://attendee.gotowebinar.com/scripts/loadMessages.js?Apr 29, 2015 12:26:52 PM"></script>
...
<script  src="https://attendee.gotowebinar.com/scripts/page/addThisEvent.js?Apr 29, 2015 12:26:52 PM" ></script>
