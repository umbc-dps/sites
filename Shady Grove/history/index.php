...
<html lang="en"><head>
<meta charset="UTF-8" />
<title>History Program | UMBC at Shady Grove</title>
...
<div id="container">
      <div id="subheaderpic">
		...
		<img src="../images/UMBC_ShadyGrove_History.gif" width="1000" height="270" alt="history" />
   	    </div>
            
   	  </div><!-- end subheaderpic -->

<div class="breadcrumb">
<p class="breadcrumb" style="margin-bottom: 0"><a href="../index.php">UMBC at The Universities at Shady Grove</a> / Undergraduate / History</p>
</div>
...
<strong>Hear from some of our history students and learn what YOU can do with a history degree via the following video!</strong><br><br>


<a href="https://www.youtube.com/watch?v=7xOc2rYLcws" target="_blank"><img src="../images/why-history.PNG"></a>
<br><br>
...
<hr><br>
  ...
  <strong>Meet Susan, <br>
  a graduate from the <br>
  UMBC-Shady Grove <br>
  history program, <br>
  in the video below. </strong><a href="http://www.youtube.com/watch?v=TUuaIG1e-Gc" target="_blank"><img src="../images/youtubesusan.jpg" alt="" width="173" height="99"></a>
<br>
<br>
...
<p>The History Program also offers a minor in public history, a  field which brings together historians with partners and audiences to engage in  productive conversations about the value and usefulness of the past.  The public history minor introduces students to  a wide breadth of practices, including historic sites documentation, cultural  resources management, historic preservation planning, oral history, museum  studies, and digital history.  All our  students are encouraged to engage in active learning and research experiences  in the many museums, historical societies and government agencies in the  Washington-Baltimore metropolitan area.</p>
<p>Students  enrolling in the Bachelor of Arts program in History at UMBC-Shady Grove will  complete approximately two years of full-time study prior to entry and complete  the remainder of their upper-level credits with UMBC-Shady Grove.  Students may transfer a maximum of 60 credits  from a two-year school and 90 credits from a four-year school to UMBC. </p>
