...
<meta property="og:image" content="http://www.umbc.edu/shadygrove/cyber/images/bk.jpg" />
...
form#ss-form {padding-left: 20%;}
input#ss-submit {width: 80%;}
div#ss-item{text-align:center}
form#ss-form input, form#ss-form select{ font-size: 16pt; color: #000;}
.ss-form-entry input, .ss-form-entry select { width: 80%; margin-bottom: 15px; }
.ss-q-title{font-weight: bold}
.ss-required-asterisk{text-align:right; font-style:italic; padding-right: 10%}
</style>
