...
<h4>
	<p class="event-links">
    	<strong>See Events For:</strong><br>
			<a href="#" class="event-link-undergrad button btn-sm">Undergraduate</a><br>
            <a href="#" class="event-link-grad button btn-sm">Graduate</a>
	</p>
</h4>
...
$('.event-link-grad').click(function() {
	$('.grad').show();
	$('.undergrad').hide();
});
$('.event-link-undergrad').click(function() {
	$('.grad').hide();
	$('.undergrad').show();
});
$('.event-links a').click(function() {
	var eventText = $(this).text();
	ga('send', 'event',  'details', 'click', eventText);
});
</script>
