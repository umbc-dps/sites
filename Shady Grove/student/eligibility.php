...
<head>
    <meta charset="UTF-8" />
    <title>Eligibility | Student Resources | UMBC at Shady Grove</title>
...
<div id="container">
        ...
        <div class="window_overlay">
          <p style="font-family: Palatino Linotype, Book Antiqua, Palatino, serif;font-size:2.9em;color:#fff;position:relative;margin-top:1px;padding-left:10px">Student Resources</p>
        </div>
...
<p class="breadcrumb" style="margin-bottom: 0"><a href="../index.php">UMBC at The Universities at Shady Grove</a> / Eligibility</p>
</div>
...
<div id="sub_content">
  <h1>Eligibility</h1>
  <p>&nbsp;</p>
  <p>UMBC-Shady Grove works very closely with Student Support Services on the main campus to provide services for registered Shady Grove students with disabilities.  Students with physical or learning disabilities who would like accommodation services and support must register with Student Support Services as soon as possible.</p>
  <p>To be eligible for Student Support Services at UMBC, students must meet <u>some</u> of the following criteria:</p>
  <ul>
    ...
    <li>Have a need for academic support <br>
    </li>
</ul>
  <p>The following services are available to Student Support  Services participants: <br>
  </p>
  <ul>
