...
(function($) {
		...
		return this.each(function () {
			...
			function buildNav() {
				...
				if ( o.navPosition === 'above' || o.navPosition === 'both' ) {
					// $box.prepend('<div class="quovolve-nav quovolve-nav-above"></div>'); // =JLD orginally prepended - changed to append below.
					$box.append('<div class="quovolve-nav quovolve-nav-above"></div>');
	...
	$.fn.quovolver.defaults = {
		...
		navPrevText : '<<', // Text for the "previous" button
