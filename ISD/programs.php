...
<title>Programs | Instructional Systems Development at UMBC</title>
...
<!-- Open Graph data -->
<meta property="og:title" content="Programs | Instructional Systems Development at UMBC" />
<meta property="og:type" content="article" />
<meta property="og:url" content="http://www.umbc.edu/isd/programs" />
...
<!-- START Content --> 
 <h3>Programs</h3>
 <p>With today's mobile workforce, rapidly changing technology and growing global market, organizations must make performance improvement and training a top priority. For training and development professionals, this means implementing the most innovative approaches and cutting-edge practices available in their work. With UMBC's ISD-Training Systems Graduate Program, you have the following options:</p>

<h4>Graduate Programs</h4>
 <UL>
   <li><a href="programmaster">Master's of Arts in Instructional Systems Development - Training Systems</a> (36 credits)</li>
 </UL>
 
 <h4>Certificate Programs</h4>
 <ul>
  <li><a href="programcert#1">Graduate Certificate in Instructional Technology</a> (12 credits)</li>
   <li><a href="programcert#2">Graduate Certificate in Instructional Systems Development</a> (12 credits)</li>
   <li><a href="programcert#3">Graduate Certificate in Distance Education</a> (12 credits)</li>
   <li><a href="programcert#4">Instructional Design for E-Learning</a> (12 credits) No longer accepting applications starting fall 2015</li>
 </ul>
