...
<head>
<meta charset="UTF-8">
<title>Schedule Adjustment | Winter Programs at UMBC</title>
...
<!-- Open Graph data -->
<meta property="og:title" content="Schedule Adjustment | Winter Programs at UMBC" />
...
<br>  
<h3 style="font-size:150%"><strong>Changes during Schedule Adjustment Period (January 4 - 7)</strong></h3>
...
<ul>
  <li>Registration remains open during the schedule  adjustment period (the first four days of winter session). See <a href="registrationtips">registration  tips</a> for details on how to enroll.</li>
...
<ul>
  ...
  <li>After the last day to drop courses with a grade of  &quot;W,&quot; the only way to drop a course is to withdraw from the session <strong>entirely</strong> (drop <strong>all</strong> courses in the winter session term).</li>
</ul>
</div>
