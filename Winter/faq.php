...
<head>
<meta charset="UTF-8">
<title>FAQs | Winter Session at UMBC</title>
...
<!-- Open Graph data -->
<meta property="og:title" content="FAQs | Winter Session at UMBC" />
...
<i class="fa fa-angle-down"></i></h4>
 ...
 <div class="accordionbody">
          <ul>
            ...
            <li>New or visiting students must <a moz-do-not-send="true" href="http://www.umbc.edu/summer/parking">request a permit</a> to park on the UMBC campus in non-metered lots or on roadways from 7:00 am until 7:00 p.m. (Monday through Thursday) and from 7:00 am until 3:30 p.m. on Friday. </li>
          </ul>
 </div>
...
<div class="accordionheader">
 ...
 <div class="accordionbody">
  ...
  <li><a href="http://www.dineoncampus.com/umbc/show.cfm?cmd=_summerSession">Meal Plans</a> are also available.</li></ul>
</div>
...
<ul>
  ...
  <li><a href="housing" target="_blank">Click here</a> for Winter Session information.</li>
</ul>
</div>
<br>
...
You can grant permission to let others see your schedule or grades through &ldquo;profile sharing&rdquo; in <em>my</em>UMBC. <br>
 ...
 <div class="accordionbody">
      ...
      <ul>
        ...
        <li>You must submit your request for<a href="excesscredit" target="_blank"> excess credit</a> approval in time to be reviewed and processed before the start of the session.</li>
      </ul>
 ...
 <div class="accordionbody">
  ...
  <div class="accordionheader">
  <h4>How Do I Check My Final Grade(s)?<i class="fa fa-angle-down"></i></h4>
 </div>

 <div class="accordionbody">
<ul>
<li>Log-in to <a href="http://my.umbc.edu/" target="_blank">myUMBC</a>.</li>
...
<li>Click Continue, and your grades will display on the screen.</li>
  ...
  <div class="accordionheader">
  <h4>How Do I Order Transcripts?<i class="fa fa-angle-down"></i></h4>
 </div>

 <div class="accordionbody">
<ul>
  <li>Order official UMBC transcripts through <a href="http://registrar.umbc.edu/services/records/">Parchment</a>,  UMBC&rsquo;s online transcript partner.</li>
  <li>View a video on <a class="video" href="https://www.youtube.com/watch?v=kvfB5X7Ej1E">How to Order Your Transcript</a></li>
