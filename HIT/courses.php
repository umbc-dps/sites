...
<title>Course Descriptions | Health Information Technology at UMBC</title>
...
<!-- Open Graph data -->
<meta property="og:title" content="Course Descriptions | Health Information Technology at UMBC" />
<meta property="og:type" content="article" />
<meta property="og:url" content="http://www.umbc.edu/hit/courses" />
...
<!-- END Page Header -->
    ...
    <div class="eleven columns">
      <div class="narrowchart">
        <div id="accordion">
          <!-- START Content -->
          <h3>Health Information Technology Course Descriptions</h3>
          <p><strong>Note:</strong> Not all HIT courses are offered every semester, and new courses may be added at any time. Check the <a href="schedule">schedule of classes</a> for the latest offerings. </p>
...
<div class="accordionheader">
            <h4><a href="#HIT658" id="HIT658"></a>HIT 658: Health Informatics I<i class="fa fa-angle-down"></i></h4>
          </div>
...
As the first required course in the series, Health  Informatics I starts with introductory topics and proceeds with an overview of  the essential topics of Health IT. Consistent with the interdisciplinary nature  of Health IT, the course touches people and organizational aspects of health  information systems as well as technology. While covering the essentials of  Health Informatics, the course also achieves depth by engaging students in a  semester- long study of a particular topic in Health IT. Some of the topics  covered in this course include electronic health records, practice management,  health information exchange, data standards, consumer health informatics and  mobile health.
   ...
   <div class="accordionheader">
            <h4><a href="#HIT759" id="HIT759"></a>HIT 759: Health Informatics II<i class="fa fa-angle-down"></i></h4>
          </div>


          <div class="accordionbody">
            <p>
 As the second required course in the health informatics series, Health  Informatics II extends the coverage of the health informatics issues into areas  such as online medical resources and search engines, evidence-based medicine  and clinical practice guidelines, disease management, disease registries and  quality improvement, patient safety and health IT, electronic prescribing,  telemedicine, and bioinformatics. <strong>Prerequisite:</strong> Health Informatics I.</p>
   </div>

<div class="accordionheader">
            <h4><a href="#HIT663" id="hit663"></a>HIT 663: Health IT Policy and Administration<i class="fa fa-angle-down"></i></h4>
          </div>
         ...
         <div class="accordionheader">   
<h4><a href="#HIT750" id="HIT750"></a>HIT 750: Data Analytics <i class="fa fa-angle-down"></i></h4>
	</div>
 <div class="accordionbody">
...
<div class="accordionheader">
          ...
          <div class="accordionbody">
            ...
            <p>The course will focus on emerging technology for decision support, including “infobuttons”, which are context-aware links from any application to some on-line information resource.  In particular, when they are placed in electronic health records (EHRs) they are considered by the Office of the National Coordinator for Health Information Technology to be a form of “meaningful use” of the EHR.   An infobutton can be as simple as a link from a drug order entry application to a relevant drug monograph or as complex as an expert system that extracts relevant data about the patient in question, anticipates unanswered information needs and retrieves knowledge to addressing those needs.  </p>
            
            <p>Other forms of decision support, including knowledge resources, expert systems and alerting systems may also be explored during the course, depending on student interest. The course will involve discussion of publications on information needs and research on resolving them, as well as project work.  Topics will include the history clinical decision support, history of infobuttons, infobutton managers, the HL7 infobutton standard, open access infobutton systems, the use of ontologies to leverage clinical data for information retrieval functions, and evaluation of clinical decision support.</p>
</div>
