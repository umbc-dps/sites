...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en_US"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="https://attendee.gotowebinar.com/styles/main.css?Apr 29, 2015 1:14:33 PM">
        ...
        <!--[if IE 7]><link type="text/css" rel="stylesheet" href='/styles/g2wattendee-ie7.css'><![endif]-->
                                    ...
                                    <link rel="stylesheet" href="https://attendee.gotowebinar.com/styles/registration.css?$Apr 29, 2015 1:14:33 PM">
                    
                    

<link type="text/css" rel="stylesheet" href="https://global.gotowebinar.com/themes/css/148f200e7a9ebeff7a9507d7a28ab2af">
                <!-- end legacy stuff -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                                                                <input type="hidden" id="training-key" value="4560890046720443650" />
...
<div class="branding-image">
    <img src="http://images.gotowebinar.com/148f200e7a9ebeff7a9507d7a28a98d2" alt="Health Information Technology Virtual Information Session" class="img-responsive">
</div>
<h1>Health Information Technology Virtual Information Session</h1>
</div>
...
<form id="registrationForm" action="https://attendee.gotowebinar.com/registration.tmpl" method="POST" role="form">
    <div class="trainingTimesBox clearfix">
                ...
                <ol id="training-times" class="trainingTimes">
	    		    	        	        	                                                            	        <li class="next">Tue, Jun 9, 2015 12:00 PM - 1:00 PM EDT</li>
	     </ol>
            </div>
            <div class="row col-md-12">
...
<div class="description trainingDescription" >
            <div class="clearfix">
                <span>Join us on Tuesday,  June 9, 2015 for a virtual information session on the UMBC Health Information Technology Master's Program. Attendees will learn more about UMBC, the Health Information Technology field, as well as program curriculum and format. Participants will also have the opportunity to submit questions. Learn more about the program here: http://www.umbc.edu/hit/</span>
        </div>
</div>
<hr>
    <script>
...
<div class="row">
                <input type="hidden" id="webinar" name="webinar" value="4560890046720443650" > 		
...
<div id="customQuestions" class="row">
		                ...
		                <input type="hidden" name="customRegistrationSubmission.answers&#91;0&#93;.questionKey" value="17245159">
    ...
    >
			...
			Choose One...		</option>
                    ...
                    <option value="17245160" >
            Email
        </option>
                    <option value="17245161" >
            Facebook
        </option>
                    <option value="17245162" >
            Radio/Internet Radio
        </option>
                    <option value="17245163" >
            LinkedIn
        </option>
                    <option value="17245164" >
            Other
        </option>
    	</select>
    </div>
		                ...
		                <input type="hidden" name="customRegistrationSubmission.answers&#91;1&#93;.questionKey" value="17245165">
                                           <div class="form-group  col-sm-12">
...
<script src="https://attendee.gotowebinar.com/scripts/app.js?Apr 29, 2015 1:14:33 PM"></script>
<script src="https://attendee.gotowebinar.com/scripts/page/registration.js?Apr 29, 2015 1:14:33 PM"></script>



<script src="https://attendee.gotowebinar.com/scripts/loadMessages.js?Apr 29, 2015 1:14:33 PM"></script>
...
<script  src="https://attendee.gotowebinar.com/scripts/page/addThisEvent.js?Apr 29, 2015 1:14:33 PM" ></script>
